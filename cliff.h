...
{
    return (~GPIO_PORTE_DATA_R) & (BIT4 - 1); //This will return the button status
}
...
/*    if((button_checkButton() & BIT5) == BIT5)
    {
        return 6;
    }
    else if((button_checkButton() & BIT4) == BIT4)
    {
        return 5;
    }
*/ //May be used later on
    ...
    if ((button_checkButtons() & BIT3) == BIT3)
    {
        return 4;
    }
    else if ((button_checkButtons() & BIT2) == BIT2)
    {
        return 3;
    }
    else if ((button_checkButtons() & BIT1) == BIT1)
    {
        return 2;
    }
    else if ((button_checkButtons() & BIT0) == BIT0)
    {
        return 1;
    }
    else
